  ...
  return (
    <div className="fixed right-2 sm:right-3 md:right-6 bottom-16 sm:bottom-20 md:bottom-24 z-40 flex flex-col space-y-2 sm:space-y-3">
      ...
      <div
        ...
        className="relative w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full shadow-lg transition-all duration-200 flex items-center justify-center hover:scale-110 active:scale-95"
      >
        <ThemeToggle />
        {showTooltip === "theme" && (
      ...
      <button
        ...
        onMouseLeave={() => setShowTooltip("")}
        className="relative w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-white dark:bg-white text-slate-600 dark:text-slate-900 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center hover:scale-110 active:scale-95"
      >
